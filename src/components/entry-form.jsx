    ...
    return (
        <form>
            ...
            <div style={{ margin: '10px', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <EntryAttribute title="Height: " propertyName="height" value={entryFormData.height} setAttributeValue={setAttributeValue} inputType="number" />

                <EntryAttribute title="Depth: " propertyName="depth" value={entryFormData.depth} setAttributeValue={setAttributeValue} inputType="number" />

                <EntryAttribute title="positionX: " propertyName="positionX" value={entryFormData.positionX} setAttributeValue={setAttributeValue} inputType="number" />

                <EntryAttribute title="positionY: " propertyName="positionY" value={entryFormData.positionY} setAttributeValue={setAttributeValue} inputType="number" />

                <EntryAttribute title="positionZ: " propertyName="positionZ" value={entryFormData.positionZ} setAttributeValue={setAttributeValue} inputType="number" />
            </div>
